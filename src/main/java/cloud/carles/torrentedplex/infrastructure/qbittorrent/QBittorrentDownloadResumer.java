...
import cloud.carles.torrentedplex.application.service.download.DownloadResumer;
...
@Service
public class QBittorrentDownloadResumer implements DownloadResumer {
    @Autowired
    ...
    public void execute(String fileId) throws DownloadStatusChangeFailedException {
        ...
        try {
            Response response = qBittorrentRequest.post("/torrents/resume", formBody);
